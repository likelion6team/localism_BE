package com.sku.localism_be.domain.auth.controller;
...
import com.sku.localism_be.domain.auth.service.AuthService;
...
public class AuthController {
  ...
  public ResponseEntity<BaseResponse<LoginResponse>> login(
    ...
    refreshTokenCookie.setMaxAge(60 * 60 * 24 * 7);  // 예: 7일 refreshToken 만료 기간
